...
object AlbumCache {
    ...
    private val albumArtCache = object : LinkedHashMap<String, Bitmap?>(MAX_CACHE_SIZE, 0.75f, true) {
        override fun removeEldestEntry(eldest: Map.Entry<String, Bitmap?>): Boolean {
            return size > MAX_CACHE_SIZE
        }
    }

    private val albumArtTimestamps = object : LinkedHashMap<String, Long>(MAX_CACHE_SIZE, 0.75f, true) {
